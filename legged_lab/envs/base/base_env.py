...
class BaseEnv(VecEnv):
    ...
    def init_obs_buffer(self):
        if self.add_noise:
            ...
            noise_vec[:3] = noise_scales.ang_vel
            noise_vec[3:6] = noise_scales.projected_gravity
            noise_vec[6:9] = 0
            noise_vec[9 : 9 + self.num_actions] = noise_scales.joint_pos
            noise_vec[9 + self.num_actions : 9 + self.num_actions * 2] = noise_scales.joint_vel
