...
class CatTraverseRewardCfg:
    ...
    tracking_root_field = RewTerm(func=mdp.cat_tracking_root_field, weight=2.0)
    ...
    # Weights / PF terms aligned with ``logs/.../params/env.yaml`` (e.g. Hole_Add_HandHead).
    headgf = RewTerm(func=mdp.cat_pf_alignment_reward, weight=5.0, params={"group_name": "head", "tau": 0.3})
    feetgf = RewTerm(
        func=mdp.cat_pf_alignment_reward,
        weight=5.0,
        params={"group_name": "feet", "tau": 0.3, "block_stance_feet": True},
    )
    handsgf = RewTerm(func=mdp.cat_pf_alignment_reward, weight=5.0, params={"group_name": "hands", "tau": 0.3})
    ...
    handsdf = RewTerm(func=mdp.cat_pf_sdf_penalty, weight=3.0, params={"group_name": "hands"})
    kneesdf = RewTerm(func=mdp.cat_pf_sdf_penalty, weight=3.0, params={"group_name": "knees"})
    shldsdf = RewTerm(func=mdp.cat_pf_sdf_penalty, weight=3.0, params={"group_name": "shoulders"})
