...
from legged_lab.envs.mini2_ToC.run_cfg import Mini2_ToC_RunFlatEnvCfg
from legged_lab.envs.mini2_ToC.run_with_sensor_cfg import Mini2_ToC_RunWithSensorFlatEnvCfg
from legged_lab.envs.mini2_ToC.walk_cfg import Mini2_ToC_WalkFlatEnvCfg
from legged_lab.envs.mini2_ToC.walk_with_sensor_cfg import (
    Mini2_ToC_WalkWithSensorFlatEnvCfg,
)
...
class Mini2_ToC_Env(VecEnv):
    def __init__(
        self,
        cfg: (
            Mini2_ToC_RunFlatEnvCfg
            | Mini2_ToC_WalkFlatEnvCfg
            | Mini2_ToC_WalkWithSensorFlatEnvCfg
            | Mini2_ToC_RunWithSensorFlatEnvCfg
        ),
        headless,
    ):
        self.cfg: (
