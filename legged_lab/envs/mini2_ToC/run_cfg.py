    ...
    undesired_contacts = RewTerm(
        ...
        params={
            "sensor_cfg": SceneEntityCfg(
                "contact_sensor", body_names=[".*_knee_pitch_link", ".*_shoulder_roll_link", ".*_elbow_pitch_link", "base_link"]
            ),
            "threshold": 1.0,
        },
    )
...
@configclass
class Mini2_ToC_RunFlatEnvCfg:
    amp_motion_files_display = ["legged_lab/envs/mini2_ToC/datasets/motion_visualization/run.txt"]
    device: str = "cuda:0"
    ...
    robot: RobotCfg = RobotCfg(
        ...
        action_scale=0.25,
        terminate_contacts_body_names=[".*_knee_pitch_link", ".*_shoulder_roll_link", ".*_elbow_pitch_link", "base_link"],
...
@configclass
class Mini2_ToC_RunAgentCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    device = "cuda:0"
    ...
    # amp parameter
    amp_reward_coef = 0.3
    amp_motion_files = ["legged_lab/envs/mini2_ToC/datasets/motion_amp_expert/run.txt"]
