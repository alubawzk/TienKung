...
@configclass
class Mini2_ToC_WalkWithSensorFlatEnvCfg:
    amp_motion_files_display = ["legged_lab/envs/mini2_ToC/datasets/motion_visualization/walk.txt"]
    device: str = "cuda:0"
...
@configclass
class Mini2_ToC_WalkWithSensorAgentCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    device = "cuda:0"
    ...
    # amp parameter
    amp_reward_coef = 0.3
    amp_motion_files = ["legged_lab/envs/mini2_ToC/datasets/motion_amp_expert/walk.txt"]
